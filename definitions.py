...
TOOLS = [
    ...
    # ── Data Ingestion Tools ───────────────────────────────────────────
    {
        ...
        "description": (
            ...
            "Supported formats (34): FASTQ, FASTA, BAM, SAM, CRAM, VCF, BCF, MAF, "
            "h5ad, HDF5, MTX, Loom, GTF, GFF3, BED, BigWig, BedGraph, PDB, mmCIF, "
            "Newick, Nexus, CSV, TSV, Excel, Parquet, PDF, PNG, TIFF, SVG"
        ),
        "input_schema": {
            "type": "object",
            "properties": {
                "source": {
                    ...
                    "description": (
                        ...
                        "'https://ftp.ncbi.nlm.nih.gov/genomes/file.fa.gz', "
